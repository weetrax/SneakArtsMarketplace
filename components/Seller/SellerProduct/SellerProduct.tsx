...
const SellerProduct: React.FC<SellerProductProps> = ({ product }) => {
  return (
    <div className="group col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3">
      <img
        className="border border-[rgba(0,0,0,0)] group-hover:border group-hover:dark:border group-hover:border-primary-500 group-hover:dark:border-primary-500 h-36 w-full rounded-t-lg object-cover"
